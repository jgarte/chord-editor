...
validateBarre :: Barre -> Int -> Validated Barre
validateBarre mbarre fcount =
  let dfc = displayedFretCount fcount
    in
    case mbarre of
      Just barre ->
